...
(function (App) {
  ...
  d.helpSections = [
    ...
    {
      id: "presets", title: "Custom molecules (XYZ)",
      body: "Choose \u201ccustom molecule (XYZ)\u201d at the end of the list. Enter one atom per line: an element symbol followed by three Cartesian coordinates in angstroms. Elements H through Ne are supported, up to 30 atoms (up to 90 basis functions).\n\nThe charge field shifts the electron count: +1 removes one electron, \u22121 adds one. Systems with an odd number of electrons are computed automatically as spin doublets with the UHF method. A standard XYZ file header (atom count plus comment line) is also accepted."
    },
    {
